...
**License Type**: Unity Asset Store License
...
**Need to know more?** See the Unity Asset Store EULA for full terms.
...
This package includes proprietary native plugin libraries:
- `InternalSolver.so` (Android armv7/arm64)
- `InternalSolver.a` (iOS)
...
### Support & Updates
- Support: Provided as described in the Asset Store listing
- Updates: Provided via the Asset Store
