...
namespace Felina.ARColoringBook
{
    public class ARScannerManager : MonoBehaviour
    {
        ...
        public event Action<string, IntPtr, float> OnTextureCaptured;
    ...
    [System.Runtime.InteropServices.DllImport("Felina")]
        ...
        private unsafe void ProcessImage( ScanTarget target )
        {
            ...
            OnTextureCaptured?.Invoke( target.Name, _unwarpedTexture.GetNativeTexturePtr(), score );
        }
