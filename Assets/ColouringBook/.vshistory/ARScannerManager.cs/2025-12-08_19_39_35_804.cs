...
public class ARUnwarper : MonoBehaviour
{
    ...
    void OnEnable() { if ( imageManager ) imageManager.trackablesChanged.AddListener( OnTrackablesChanged ); }
    void OnDisable() { if ( imageManager ) imageManager.trackablesChanged.RemoveListener( OnTrackablesChanged ); }
