...
namespace Felina.ARColoringBook.Bridges
{
...
#endif
    {
        ...
        //public event Action<ScanTarget> OnTargetUpdated;
        public event Action<ScanTarget> OnTargetAdded;
        public event Action<ScanTarget> OnTargetRemoved;
        ...
        private void OnTrackablesChanged( ARTrackablesChangedEventArgs<ARTrackedImage> args )
        {
            ...
            {
                var img = args.removed[ i ];
                BroadcastTargetRemoved( img );
            }
        }
        ...
        private void BroadcastTargetRemoved( KeyValuePair<TrackableId, ARTrackedImage> removed )
        {

            var target = new ScanTarget
            {
                TrackableId = removed.Key,
                Name = removed.Value.referenceImage.name,
                Position = removed.Value.transform.position,
            };
