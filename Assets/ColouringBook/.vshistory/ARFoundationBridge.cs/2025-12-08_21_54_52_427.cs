...
namespace Felina.ARColoringBook.Bridges
{
...
#endif
    {
        ...
        private void Start()
        {
            ...
            {
                Width = Mathf.Min( _outputResolution, w ),
                Height = Mathf.Min( _outputResolution, h ),
            }
            _renderTextureSettings.Format = RenderTextureFormat.Default;

            _cameraFeedRT = new RenderTexture( w, h, 0, _renderTextureSettings.Format )
            {
                useMipMap = false,
