...
namespace Felina.ARColoringBook.Editor
{
    ...
    public class IntegrityWatcher
    {
        ...
        private static readonly Dictionary<string, string> _goldenHashes = new Dictionary<string, string>
        {
            ...
            { "Assets/Felina/Scripts/Internals.cs",      "REPLACE_WITH_ACTUAL_HASH" },
            { "Assets/Felina/Scripts/LicenseManager.cs", "REPLACE_WITH_ACTUAL_HASH" },
            { "Assets/Felina/Editor/BuildEnforcer.cs",   "REPLACE_WITH_ACTUAL_HASH" }
        };
